...
_CHIPCHAT_PROJECT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
if _CHIPCHAT_PROJECT not in sys.path:
    sys.path.insert(0, _CHIPCHAT_PROJECT)
...
def main():
    default = os.path.join(_CHIPCHAT_PROJECT, "data", "llm_output.json")
